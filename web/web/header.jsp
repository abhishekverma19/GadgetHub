  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
      <div class="container-fluid">
        <a href="index.jsp" class="navbar-brand text-white">GadgetHub </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
      <div class="container-fluid">
        <a href="userHome.jsp" class="navbar-brand text-white"> GadgetHub </a>
        ...
        <div class="collapse navbar-collapse" id="mynav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a href="shippedItem.jsp" class="nav-link">Shipped</a>
            </li>

            <li class="nav-item">
              <a href="unshippedItems.jsp" class="nav-link">Orders</a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href="addProduct.jsp" class="dropdown-item">Add Products</a>
                </li>
                <li>
                  <a href="removeProduct.jsp" class="dropdown-item">Remove Product</a>
                </li>
                <li>
                  <a href="updateProduct.jsp" class="dropdown-item">Update Product</a>
                </li>
              </ul>
            </li>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mynav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a href="orderDetails.jsp" class="nav-link">Orders</a>
            </li>
    ...
    <div class="container-fluid bg-warning text-center pb-3" style="opacity:0.9;">
      <h2>GadgetHub</h2>
