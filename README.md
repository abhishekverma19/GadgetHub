🚀 GadgetHub – Full Stack Java E-Commerce Web Application
...
🗂️ Category-wise Gadget Browsing
⚡ Server-side Rendering using JSP
🔄 Efficient Data Handling using JDBC
🧠 Architecture & Development Approach
🧩 MVC Architecture for clean separation of concerns
🧪 Reusable DAO Layer for database operations
🧵 Session Management for cart & user state
